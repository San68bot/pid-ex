...
@MotorType(ticksPerRev = 751.8, gearing = 26.9, maxRPM = 223.0, orientation = Rotation.CW, achieveableMaxRPMFraction = 1.0)
...
@MotorType(ticksPerRev = 28.0, gearing = 1.0, maxRPM = 6000.0, orientation = Rotation.CW, achieveableMaxRPMFraction = 1.0)
@DeviceProperties(xmlTag = "Go_1:1", xmlTagAliases = ["Go_1:1"], name = "Go_1:1", builtIn = false)
interface Go_6000